...
export const env = {
  ...
  STRIPE_PRICE_CANDIDATE_SUBDOMAIN_ADDON:
    process.env.STRIPE_PRICE_CANDIDATE_SUBDOMAIN_ADDON || "",
  STRIPE_PRICE_CANDIDATE_SINGLE_DOMAIN:
    process.env.STRIPE_PRICE_CANDIDATE_SINGLE_DOMAIN || "",
  STRIPE_PRICE_CANDIDATE_FULL_BUNDLE:
    process.env.STRIPE_PRICE_CANDIDATE_FULL_BUNDLE || "",
